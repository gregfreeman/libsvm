...
try
	...
	% Add -largeArrayDims on 64-bit machines of MATLAB
		...
		mex CFLAGS="\$CFLAGS -std=c99 -fno-builtin" -largeArrayDims libsvmread.c
		mex CFLAGS="\$CFLAGS -std=c99 -fno-builtin" -largeArrayDims libsvmwrite.c
		mex CFLAGS="\$CFLAGS -std=c99 -fno-builtin" -largeArrayDims svmtrain.c ../svm.cpp svm_model_matlab.c
		mex CFLAGS="\$CFLAGS -std=c99 " -largeArrayDims svmpredict.c ../svm.cpp svm_model_matlab.c
		mex CFLAGS="\$CFLAGS -std=c99 -fno-builtin" -largeArrayDims libsvmreadmodel.c ../svm.cpp svm_model_matlab.c
		end
	end
catch
